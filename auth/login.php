...
if (isset($_POST['submit'])) {
    ...
    if ($username == 'Jamie' && $password == 'pass') {
        ...
        <div class="min-w-fit flex-col border bg-white px-6 py-14 shadow-md rounded-[4px] ">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                <div class="flex flex-col text-sm rounded-md">
                    <input class="mb-5 rounded-[4px] border p-3 hover:outline-none focus:outline-none hover:border-yellow-500 " type="text" name="username" placeholder="Username" />
                ...
                <button class="mt-5 w-full border p-2 bg-gradient-to-r from-gray-800 bg-gray-500 text-white rounded-[4px] hover:bg-slate-400 scale-105 duration-300" type="submit" name="submit">Sign in</button>
            </form>
